...
## Lernziele
* **Flexibilität:** Speichern von verschiedenen Typen im selbern Array, ohne Joins. [Game Items, verschiedene Objekten in einem Katalog, Webshops Verwaltung, Inventar eines Lagers usw.]
...
##### ** Docker compose noch pendent (issues)
